...
def test_psi_is_large_for_a_known_shift():
    ...
    shifted = rng.normal(3, 1, size=2000)  # clear mean shift -> should breach the 0.2 alert
...
@pytest.mark.skip(reason="TODO: implement runs.save_run / load_runs, then round-trip on a temp SQLite DB")
